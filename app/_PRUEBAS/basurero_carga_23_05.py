                ...
                try:
                    ...
                    for i in range(len(coordenadas_vehiculo)):
                        ...
                        if i == 0 or (i > 0 and coordenadas_vehiculo[i - 1].fecha != coord_curr.fecha):
                            ...
                            # Implementar reintento con espera
                            max_retries = 5
                        ...
                        # Depuración: imprimir las distancias para verificar la lógica
                        print(f"Distancia R: {distancia_r}, Distancia M: {distancia_m}")

                        # Evaluar el estado basándonos en la comparación de distancias
                        if int(distancia_r) > int(distancia_m) + 2:
                            coord_curr.estado = 2  # Coordenada no válida
                        else:
                            coord_curr.estado = 1  # Coordenada válida
